...
Not built yet: the claim RPC that actually commits a claim (C3), the claim screens (C4), the host application form and admin review screens (§9.2/§9.3), the roster (`docs/architecture/2026-08-27-event-attendee-roster.md`), email (§5), retroactive attendance history, and the purge job for expired unclaimed rows.
